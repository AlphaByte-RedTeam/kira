...
const clientSchema = z.object({
  ...
  website: z
    ...
    .url("Website must be a valid domain (e.g. example.com)"),
});
...
export function ClientManager() {
  ...
  const handleSave = async () => {
    ...
    if (editingClient) {
      ...
      await supabase
        .from("clients")
        .insert({ name, website, user_id: user.id });
    }
        ...
        <div className="flex gap-2">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will move {selectedIds.length} clients to trash.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                <Button
                  disabled={!clientSchema.safeParse({ name, website }).success}
                  onClick={handleSave}
                >
                  Save
                </Button>
